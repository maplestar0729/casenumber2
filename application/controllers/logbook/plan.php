...
class plan extends MY_Controller
{
    ...
    public function index($set_type = "")
    {
        ...
        $this->logbook_plan_template("logbook_plan/index", $data);
    }
    public function planend()
    {
        ...
        $this->logbook_plan_template("logbook_plan/planend", $data);
    }
    ...
    {
        $get_data = $this->input->get(null, true);
        $rtn = $this->logbook_plan_model->get_LogbookPage_plan__list();
        echo json_encode($rtn);
    }
    ...
    public function create_log_plan()
    {
        ...
        $create_log_data["remark"] = $post_data["today_worker"];
        $create_log_data["worker"] = $post_data["today_remark"];
        ...
        try {
            ...
            $ans = $this->logbook_plan_model->create_plan($create_log_data);
            echo "<script>";
            echo "alert(\"OK\");";
