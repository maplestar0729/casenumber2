...
<div>
    ...
    <table id="phoneBook_tab" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-columns="true"
        ...
        data-url="<?=base_url('phoneBook/get_phoneBook_list')?>" data-page-list="[10, 15 , 20, 25 , 50, 100, ALL]" data-side-pagination="server"
        data-show-footer="false" data-row-style="rowStyle" data-page-size="15" >
        <thead>

            <tr>
                <th data-field='NO' data-width='10' data-visible="false" data-sortable="true">id</th>
                <th data-field='unit' data-width='100' data-sortable="true" data-formatter="UnitFormatter" data-events="NameEvents">單位</th>
                <th data-field='name' data-width='100' data-sortable="true" data-formatter="NameFormatter" data-events="NameEvents">姓名</th>
                <th data-field='cellphone' data-width='110' data-cell-style="CellPhoneSty" data-formatter="cellPhoneFormatter"  data-events="OrderEvents" >手機</th>
                <th data-field='phone' data-width='100'>電話</th>
                <th data-field='OrderDate' data-width='110' data-sortable="true" data-formatter="OrderFormatter" data-events="OrderEvents"  data-visible="false">排序日期</th>

                <th data-formatter="OtherFormatter" data-events="OtherEvents" data-width='50'  data-visible="false">其他</th>
            </tr>
        </thead>
    </table>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <div class="form-group col-md-12">
                    <h3 class="modal-title col-xs-3" data-view="name" style="color: blue">名片</h3>
                    <h3 class="col-xs-9" data-view="phone" style="color: red">
                    </h3>
                </div>
                <!--<form  method="post" accept-charset="utf-8" id="edit_frm">-->
                <div class="form-group col-md-12">
                    <label class="col-xs-5 control-label">分類</label>
                    <div class="col-xs-7" data-view="class">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <label class="col-xs-5 control-label">E-mail</label>
                    <div class="col-xs-7" data-view="mail">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <label class="col-xs-5 control-label">傳真</label>
                    <div class="col-xs-7" data-view="fax">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <label class="col-xs-5 control-label">電話2</label>
                    <div class="col-xs-7" data-view="phone2">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <label class="col-xs-5 control-label">住址</label>
                    <div class="col-xs-7" data-view="address">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <label class="col-xs-5 control-label">單位</label>
                    <div class="col-xs-7" data-view="unit">
                    </div>
                </div>
                <!-- <div class="form-group col-md-12" >
                            <div class="col-md-10">
...
<script>
    ...
    function CellPhoneSty(value, row, index) {
        return {
            classes: "CellPhoneSty"
        };
    }
    ...
    function UnitFormatter(value, row, index) {
        var tmp_str = "";
        tmp_str += '<a class="UnitCell DataView" href="#dataViewModal" data-toggle="modal" >' + value + '</a>';
        return [
            tmp_str
        ].join('');
    }
    function NameFormatter(value, row, index) {
        var tmp_str = "";
        tmp_str += '<a class="NameCell DataView" href="#dataViewModal" data-toggle="modal" >' + value + '</a>';
        return [
            tmp_str
        ].join('');
    }
    ...
    function cellPhoneFormatter(value, row, index) 
    {
        var tmp_str = '<a class="glyphicon glyphicon-eject DateUp" style="color : blue"></a>';
        tmp_str += value;
        return [
            tmp_str
        ].join('');
