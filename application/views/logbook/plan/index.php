        ...
        <table id="logbook_tab" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-columns="true" data-show-export="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="false" data-url="<?= base_url("logbook_plan/get_plan_list" . $tab_search_str) ?>" data-page-list="[10, 20, 25 , 50, 100, ALL]" data-show-footer="false" data-row-style="rowStyle" <?php if ($this->session->userdata('case_number')["class"] != 3) { ?> style="width:1360px" <?php } else { ?> style="width:1300px" <?php } ?>>
            <thead>
                ...
                <tr>
                    ...
                    <th data-field='state2' data-formatter="schFormatter" data-width='200'>進度</th>
                    <th data-field='remark2' data-formatter="Remark2Formatter" data-events="Remark2Events" data-width='200'>主管註記</th>
                    <th data-field='state' data-width='110' data-formatter="StateFormatter" data-events="OtherEvents">草稿或公開</th>
                    <th data-field='Other' data-formatter="OtherFormatter" data-events="OtherEvents" data-width='50'>刪除否</th>
...
<div>
    ...
    <div id="historylog_logbook">
        ...
        <table id="logbook_tab" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-columns="true" data-show-export="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="false" data-url="<?= base_url("logbook_plan/get_plan_END_list") ?>" data-page-list="[10, 20, 25 , 50, 100, ALL]" data-show-footer="false" data-row-style="rowStyle" style="width:1440px">
            <thead>

                <tr>
                    <th data-field='NO' data-width='10' data-visible="false">id</th>
                    <th data-field='date' data-width='100'>預計完成日期</th>
                    <th data-field='member' data-formatter="MemberFormatter_END" data-width='80'>成員</th>
                    <th data-field='type' data-width='110' data-formatter="TypeFormatter">工作類型</th>
                    <th data-field='state' data-width='110' data-formatter="StateFormatter">工作類型</th>
                    <th data-field='caseno' data-width='100' data-sortable="true" data-filter-control="true">案件編號</th>
                    <th data-field='name' data-width='250'>案件名稱</th>

                    <th data-field='content' data-width='150'>工作內容</th>
                    <th data-field='remark' data-width='100'>備註說明</th>
                    <th data-field='state2' data-formatter="schFormatter_END" data-width='50'>進度</th>
                    <th data-field='remark2' data-formatter="Remark2Formatter" data-events="Remark2Events" data-width='200'>主管註記</th>
