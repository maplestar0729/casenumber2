...
<div id="history_logbook">
    <ul class="list-inline">
        <li class=" col-md-2">
            <span class="pl_t musPick">工作計劃</span>
        </li>
    </ul>
    <div id="toolbar" class="list-inline">

    </div>
    <table id="logbook_tab" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-columns="true" data-show-export="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="false" data-url="<?= base_url("logbook_plan/get_LogbookPage_plan__list") ?>" data-page-list="[10, 20, 25 , 50, 100, ALL]" data-show-footer="false" data-row-style="rowStyle" style="width:1390px">
        <thead>

            <tr>
                <th data-field='NO' data-width='10' data-visible="false">id</th>
                <th data-field='date' data-width='100' data-sortable="true">日期</th>
                <th data-field='member' data-width='80' data-formatter="PlanMemberFormatter" data-sortable="true">成員</th>
                <th data-field='type' data-width='80' data-formatter="StateFormatter">工作類型</th>
                ...
                <th data-field='state2' data-width='80' data-formatter="schFormatter_END" data-sortable="true">進度</th>
                <th data-field='remark2' data-width='200' data-formatter="Remark2Formatter">主管註記</th>
...
<div id="Individual_work_plan">
    ...
    <form action="<?= base_url('/logbook/create_log_today') ?>" method="POST" accept-charset="utf-8" id="today_logbook_frm">
        ...
        <ul class="list-inline" id="today_logbook_title">
            <li class=" col-md-2">
                <span class="pl_t musPick">今天日誌</span>
            </li>
            <li class=" col-md-2">
    ...
    <div id="history_logbook_title">
        <ul class="list-inline">
            <li class="col-md-2">
                <span class="pl_t musPick">工作記錄</span>
            </li>
    ...
    <div id="history_logbook">
        ...
        <table id="history_logbook_tab" data-toggle="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-columns="true" data-show-export="true" data-detail-formatter="detailFormatter" data-minimum-count-columns="2" data-show-pagination-switch="true" data-pagination="false" data-url="<?= base_url("logbook/search_caseno" . $tab_search_str) ?>" data-page-list="[10, 20, 25 , 50, 100, ALL]" data-show-footer="false" data-row-style="rowStyle" <?php if ($this->session->userdata('case_number')["class"] != 3) { ?> style="width:1240px" <?php } else { ?> style="width:1180px" <?php } ?>>
            <thead>
                ...
                <tr>
                    ...
                    <?php } ?>
                    <th data-field='length' data-width='50' data-formatter="LengthFormatter">時數</th>
                    <th data-field='type' data-width='110' data-formatter="StateFormatter">工作類型</th>
                    <th data-field='caseno' data-width='100' data-sortable="true" data-filter-control="true">案件編號</th>
                    <th data-field='name' data-width='300'>案件名稱</th>

                    <th data-field='content' data-width='250'>工作內容</th>
                    <th data-field='remark' data-width='200'>備註說明</th>
                    <th data-field='remark2' data-formatter="Remark2Formatter" data-events="Remark2Events" data-width='200'>請批評指教</th>
...
<script>
    ...
    function work_contentFormatter(value, row, index) {
        ...
        return [
            '<div style="font-size:20px;color:black" >' + row.remark + '</div>'
        ].join('');
    }
    ...
    function OtherDelFormatter(value, row, index) {
        var rtn_str = "";
        //if(row.state == "A" )
        //{
    ...
    function PlanMemberFormatter(value, row, index) {
        var rtn_str = "";
    ...
    window.OtherDelEvents = {
        'click .plan_del': function(e, value, row, index) {
            ...
            update_plan(stn_data, function() {
                ...
                $("#logbook_tab").bootstrapTable('remove', {
                    field: 'NO',
                    values: [row.NO]
                });
                //location.reload();
